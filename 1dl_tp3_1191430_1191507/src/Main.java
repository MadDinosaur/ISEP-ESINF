...
public class Main {
    static String FILE_NAME_1 = "2dl_tp3_1191430_1191507/Periodic Table of Elements.csv";
            ...
            while (op != 0) {
                switch (op) {
                    ...
                    case 4:
                        ...
                        BinaryTree<String> bstElectronConfig = periodicTable.generateElectronConfigTree(periodicTable.getPatterns(3));
    ...
    /**
     * Pesquisa de elementos através do número atómico
     *
     * @param number
     */
    ...
    /**
     * Pesquisa de elementos através do nome do elemento
     *
     * @param element
     */
    ...
    /**
     * Pesquisa de elementos através do símbolo/abreviação
     *
     * @param symbol
     */
    ...
    /**
     * Pesquisa de elementos através da massa atómica
     *
     * @param number
     */
    ...
    /**
     * Pesquisa por intervalos de massa atómica.
     * Apresenta a informação acerca de todos os elementos com massa atómica no intervalo [minAtomicMass, maxAtomicMass]
     *
     * @param minAtomicMass
     * @param maxAtomicMass
     */
    ...
    /**
     * Mostra por ordem decrescente as configurações eletrónicas com mais do que uma repetição, agrupadas por número de repetições
     */
    ...
    /**
     * Mostra as duas configurações eletrónicas mais distantes numa árvore AVL - onde constam as configurações eletrónicas,
     * inseridas por ordem decrescente e ordenadas alfabeticamente, com repetição acima de 2
     */
    ...
    /**
     * Constrói uma árvore binária completa com as configurações eletrónicas com repetição acima de 2
     */
    public static void completeElectronConfigTree() {
        ...
        //BinaryTree<String> insertionList = periodicTable.generateElectronConfigTree(periodicTable.getPatterns(1, 2));
        ...
        completeBstElectronConfig.completeTree(bstElectronConfig.inOrder());
        System.out.printf("\n%s\n", completeBstElectronConfig.toString());
    }
